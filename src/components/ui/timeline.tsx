...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-[#020612] font-sans dark:bg-neutral-950"
      ref={containerRef}
    >
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              <div className="absolute left-3 flex h-10 w-10 items-center justify-center rounded-full bg-[#1e253b] dark:bg-black md:left-3">
                <div className="h-4 w-4 rounded-full border border-neutral-300 bg-[#020612] p-2 dark:border-neutral-700 dark:bg-neutral-800" />
              </div>
